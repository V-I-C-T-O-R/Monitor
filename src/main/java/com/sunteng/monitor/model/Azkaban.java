...
public class Azkaban extends Result {
    ...
    private List<Azkabanlogs> azkabanlogsList = new ArrayList<Azkabanlogs>();
    private List<AzkabansExecutingflows> azkabansExecutingflowses = new ArrayList<AzkabansExecutingflows>();
    ...
    public void putAzkabansExecutingflowses(AzkabansExecutingflows azkabansExecutingflows) {
        this.azkabansExecutingflowses.add(azkabansExecutingflows);
    }

    public void putAzkabanlogs(Azkabanlogs azkabanlogs) {
        this.azkabanlogsList.add(azkabanlogs);
    }

    public List<AzkabansExecutingflows> getAzkabansExecutingflowses() {
        return this.azkabansExecutingflowses;
    }

    public AzkabansExecutingflows getAzkabansExecutingflows(int i) {
        return this.azkabansExecutingflowses.get(i);
    }

    public Azkabanlogs getAzkabanlog(int i) {
        return this.azkabanlogsList.get(i);
    }

    public List<Azkabanlogs> getAzkabanlogs() {
        return this.azkabanlogsList;
    }
    ...
    public class Azkabanjobs {
        ...
        public Azkabanjobs(int execId, int attempt, String endTime, String flowId, String inputParams, String jobId, String outputParams, int projectId, String startTime, int status) {
    ...
    public class Azkabanlogs {
        private int execId;
        private String content;

        public Azkabanlogs(String content, int execId){
    ...
    public class Azkabanflows {
        ...
        public Azkabanflows(int execId, String endTime, String flowId, int projectId, String startTime, int status, String submitTime, String submitUser, String updateTime) {
            this.endTime = endTime;
            this.flowId = flowId;
            this.projectId = projectId;
            this.startTime = startTime;
    ...
    public class AzkabansExecutingflows {
        private int execId;

        public AzkabansExecutingflows(int execId) {
            this.execId = execId;
        }
